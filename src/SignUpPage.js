        ...
        return (
            <div>
                ...
                <Formik
                    ...
                    onSubmit={({ firstName, lastName, username, password, terms }, { setStatus, setSubmitting }) => {
                        setStatus();
                        authenticationService.signup(firstName, lastName, username, password, terms)
                            .then(
                                result => {
                    ...
                    render={({ errors, status, touched, isSubmitting }) => (
                        <Form>
                            ...
                            <div className="form-group">
                                ...
                                <label htmlFor="terms" className="form-check-label">Terms &amp; Conditions</label>
